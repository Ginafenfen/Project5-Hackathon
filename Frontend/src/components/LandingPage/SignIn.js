...
const SignIn = () => {
  ...
  const handleSubmit = () => {
    console.log("testing from SignIn");
    console.log(reactCtx.emailReg);
    console.log(reactCtx.passwordReg);
  };
  return (
    <>
          ...
          <div className="p-8 flex-1">
            <div className="mx-auto overflow-hidden">
              <div className="p-8">
                ...
                <form className="mt-12">
                  <div className="relative">
                    <input
                      ...
                      value={reactCtx.emailReg}
                      onChange={(e) => reactCtx.setEmailReg(e.target.value)}
                    />
                    <label
                      htmlFor="email"
                ...
                <div className="mt-4 block text-sm text-center font-medium text-sky-500 hover:underline focus:outline-none focus:ring-2 focus:ring-sky-300">
